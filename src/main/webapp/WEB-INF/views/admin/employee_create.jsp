...
<div class="max-w-md mx-auto bg-white p-6 rounded shadow">
    ...
    <form method="post" action="${pageContext.request.contextPath}/admin/empleados/crear" novalidate>
        ...
        <div class="flex justify-end space-x-3">
            <a href="${pageContext.request.contextPath}/admin/empleados" class="bg-gray-500 text-white px-4 py-2 rounded">Cancelar</a>
            <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">Crear Empleado</button>
        </div>
    </form>

    <p class="mt-4 text-sm text-gray-600">Solo los administradores pueden crear nuevos empleados.</p>
</div>
</body>
</html>